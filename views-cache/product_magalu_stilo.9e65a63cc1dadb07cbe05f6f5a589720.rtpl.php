      ...
      <div class="col-md-12">
        <div class="box box-primary">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="" role="tab" aria-controls="pills-home" aria-selected="true">Magalu Stilo</a>
            </li>
            </li>
          </ul>
          <div class="box-header">
            <a href="/admin/product/magalustilo/update" class="btn btn-success">Atulizar Produtos</a>
          </div>
              <div class="box-body no-padding">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo htmlspecialchars( $value1["IdSku"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["Name"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                      <td><?php echo htmlspecialchars( $value1["Price"]["SalePrice"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
