    ...
    <section class="content" id="content">
      ...
      <div class="porcentagem">
        ...
        <div class="progress-group">
          Estoque com Pendecias B2w Stilo
          <span class="float-right"><b><?php echo htmlspecialchars( $b2wStilo, ENT_COMPAT, 'UTF-8', FALSE ); ?></b>/<?php echo htmlspecialchars( $b2wStilot, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          <div class="progress progress-sm" id="b2wStilo">
            <script>
              let s = (<?php echo htmlspecialchars( $b2wStilo, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $b2wStilot, ENT_COMPAT, 'UTF-8', FALSE ); ?>*100);
              console.warn();
              const v = document.querySelector("#b2wStilo");
              let f = `<div class="progress-bar bg-primary" style="width: `+parseInt(s)+`%;background-color: #1bc5ac;"></div>`;
              v.innerHTML = f;
            </script>
        ...
        B2w click
        <div class="progress-group">
          Estoque com Pendecias B2w Click
          <span class="float-right"><b><?php echo htmlspecialchars( $b2wClick, ENT_COMPAT, 'UTF-8', FALSE ); ?></b>/<?php echo htmlspecialchars( $b2wClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          <div class="progress progress-sm" id="b2wClick">
            <script>
              let vbc= (<?php echo htmlspecialchars( $b2wClick, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $b2wClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?>*100);
              const sbc = document.querySelector("#b2wClick");
              let ibc = `<div class="progress-bar bg-primary" style="width: `+parseInt(vbc)+`%;background-color: #1bc5ac;"></div>`;
              sbc.innerHTML = ibc;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
        ...
        Magalu stilo
        <div class="progress-group">
          Estoque com Pendecias Magalu Stilo
          <span class="float-right"><b><?php echo htmlspecialchars( $MagaluStilo, ENT_COMPAT, 'UTF-8', FALSE ); ?></b>/<?php echo htmlspecialchars( $MagaluStilot, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          <div class="progress progress-sm" id="MagaluStilo">
            <script>
              let vms = (<?php echo htmlspecialchars( $MagaluStilo, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $MagaluStilot, ENT_COMPAT, 'UTF-8', FALSE ); ?>*100);
              const sms = document.querySelector("#MagaluStilo");
              let ims = `<div class="progress-bar bg-primary" style="width: `+parseInt(vms)+`%;background-color: rgb(0, 134, 255);;"></div>`;
              sms.innerHTML = ims;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
        ...
        <div class="progress-group">
          Estoque com Pendecias B2w Stilo
          <span class="float-right"><b><?php echo htmlspecialchars( $MagaluClick, ENT_COMPAT, 'UTF-8', FALSE ); ?></b>/<?php echo htmlspecialchars( $MagaluClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          <div class="progress progress-sm" id="MagaluClick">
            <script>
              let vmc = (<?php echo htmlspecialchars( $MagaluClick, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $MagaluClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?>*100);
              console.warn();
              const smc = document.querySelector("#MagaluClick");
              let imc = `<div class="progress-bar bg-primary" style="width: `+parseInt(vmc)+`%;background-color: rgb(0, 134, 255);;"></div>`;
              smc.innerHTML = imc;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
        ...
        <div class="progress-group">
          Estoque com Pendecias B2w Stilo
          <span class="float-right"><b><?php echo htmlspecialchars( $mlClick, ENT_COMPAT, 'UTF-8', FALSE ); ?></b>/<?php echo htmlspecialchars( $mlClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          <div class="progress progress-sm" id="mlClick">
            <script>
              let vmlc = (<?php echo htmlspecialchars( $mlClick, ENT_COMPAT, 'UTF-8', FALSE ); ?>/<?php echo htmlspecialchars( $mlClickt, ENT_COMPAT, 'UTF-8', FALSE ); ?>*100);
              console.warn();
              const smlc = document.querySelector("#mlClick");
              let imlc = `<div class="progress-bar bg-primary" style="width: `+parseInt(vmlc)+`%;background-color: #f8e838;"></div>`;
              smlc.innerHTML = imlc;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
        ...
        <div class="progress-group">
          ...
          <div class="progress progress-sm" id="b2wStilo">
            <script>
              ...
              console.warn();
              const v = document.querySelector("#b2wStilo");
              let f = `<div class="progress-bar bg-primary" style="width: `+parseInt(s)+`%;background-color: #28a745;"></div>`;
              v.innerHTML = f;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
        ...
        <div class="progress-group">
          ...
          <div class="progress progress-sm" id="b2wStilo">
            <script>
              ...
              console.warn();
              const v = document.querySelector("#b2wStilo");
              let f = `<div class="progress-bar bg-primary" style="width: `+parseInt(s)+`%;background-color: #f53d2d;"></div>`;
              v.innerHTML = f;
            </script>
            <!-- <div class="progress-bar bg-primary" style="width: 8%"></div> -->
          </div>
